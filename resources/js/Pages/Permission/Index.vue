      ...
      <DataTable ref="dt" v-model:expandedRows="expandedRows" :value="permissions"
        ...
        <Column :exportable="false">
          <template #body="slotProps">
            ...
            <Button icon="pi pi-trash" iconPos="left" @click="deleteResource(slotProps.data.id)" class="p-button-rounded p-button-danger"
                    v-has-permission="{props: $page.props, permissions: ['permissions.delete']}"/>
          </template>
        </Column>
        ...
        <template #expansion="slotProps">
          <Button label="New Permission" icon="pi pi-plus" class="p-button-success mr-2 mb-2" @click="createNewPermission(slotProps.data)"
                  v-has-permission="{props: $page.props, permissions: ['permissions.create']}"/>
          ...
          <DataTable class="pt-4" :value="slotProps.data.children" responsiveLayout="scroll">
            ...
            <Column :exportable="false">
              <template #body="slotProps">
                ...
                <Button icon="pi pi-trash" iconPos="left" @click="deleteResource(slotProps.data.id)" v-has-permission="{props: $page.props, permissions: ['permissions.delete']}"
